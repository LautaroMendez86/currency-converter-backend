...
namespace CurrencyConverter.Migrations
{
    ...
    [Migration("20240818221608_ChangeTypeVariablesInSomeFields")]
    partial class ChangeTypeVariablesInSomeFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CurrencyConverter.Entities.ConverterHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CurrencyConverter.Entities.ConverterHistory", b =>
                {
                    b.HasOne("CurrencyConverter.Entities.Currency", "CurrencyFrom")
                        .WithMany()
                        .HasForeignKey("CurrencyFromId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CurrencyConverter.Entities.Currency", "CurrencyTo")
                        .WithMany()
